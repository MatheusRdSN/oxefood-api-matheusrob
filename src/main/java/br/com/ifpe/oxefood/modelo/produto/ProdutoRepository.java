...
@Query(value = "SELECT p FROM Produto p WHERE p.codigo = :codigo") // JPQL se refere a classe e seus atributos, e não a tabela e seus campos como no SQL
// quando a variavel tem : na frente, como esse :codigo, é uma variavel que será passada como parâmetro
...
//IgnoreCase: ignora se é maiúscula ou minúscula
//OrderBy: ordena por ordem alfabética
